...
(function () {
    ...
    function newContext(a) {
        ...
        function u(a, c) {
            ...
            e && (e = t(e, f)),
            a && (e ? (l = h[e], l && l.normalize ? j = l.normalize(a, function (a) {
                return t(a, f)
    ...
    define = function (a, b, c) {
        ...
        isArray(b) || (c = b, b = []),
        !b.length && isFunction(c) && c.length && (c.toString().replace(commentRegExp, "").replace(cjsRequireRegExp, function (a, c) {
            b.push(c)
...
function (a, b) {
    ...
    function vc(a) {
        if (!kc[a]) {
            ...
            d.remove();
            if (e === "none" || e === "") {
                lc || (lc = c.createElement("iframe"), lc.frameBorder = lc.width = lc.height = 0),
                b.appendChild(lc);
                if (!mc || !lc.createElement) mc = (lc.contentWindow || lc.contentDocument).document,
                mc.write((c.compatMode === "CSS1Compat" ? "<!doctype html>" : "") + "<html><body>"),
                mc.close();
                d = mc.createElement(a),
                mc.body.appendChild(d),
                e = f.css(d, "display"),
                b.removeChild(lc)
            }
            kc[a] = e
    ...
    f.Callbacks = function (a) {
        ...
        var c = [],
            ...
            fireWith: function (b, c) {
                return d && (i ? a.once || d.push([b, c]) : (!a.once || !e) && n(b, c)),
                this
            },
            fire: function () {
    ...
    f.fn.extend({
        ...
        val: function (a) {
            var c, d, e, g = this[0];
            if (!arguments.length) {
                if (g) return c = f.valHooks[g.nodeName.toLowerCase()] || f.valHooks[g.type],
    ...
    f.fn.extend({
        ...
        off: function (a, c, d) {
            if (a && a.preventDefault && a.handleObj) {
                var e = a.handleObj;
                return f(a.delegateTarget).off(e.namespace ? e.type + "." + e.namespace : e.type, e.selector, e.handler),
                this
            }
            if (typeof a == "object") {
        ...
        clean: function (a, b, d, e) {
            ...
            (k = a[j]) != null; j++) {
                ...
                if (typeof k == "string") if (!_.test(k)) k = b.createTextNode(k);
                    ...
                    b === c ? hb.appendChild(o) : U(b).appendChild(o),
    ...
    f.extend({
        ...
        style: function (a, c, d, e) {
            ...
            h = typeof d,
            h === "string" && (g = vb.exec(d)) && (d = +(g[1] + 1) * +g[2] + parseFloat(f.css(a, c)), h = "number");
    ...
    c.documentElement.currentStyle && (Bb = function (a, b) {
        ...
        !tb.test(f) && ub.test(f) && (c = g.left, d = a.runtimeStyle && a.runtimeStyle.left, d && (a.runtimeStyle.left = a.currentStyle.left), g.left = b === "fontSize" ? "1em" : f || 0, f = g.pixelLeft + "px", g.left = c, d && (a.runtimeStyle.left = d)),
        f === "" ? "auto" : f
    }),
    zb = Ab || Bb,
            ...
            return f.ajax({
                ...
                complete: function (a, b, c) {
                    ...
                    a.isResolved() && (a.done(function (a) {
                        c = a
                    }), i.html(g ? f("<div>").append(c.replace(Nb, "")).find(g) : c)),
                    d && i.each(d, [c, b, a])
                }
            }),
            this
    ...
    f.extend({
        ...
        ajaxSetup: function (a, b) {
            return b ? _b(a, f.ajaxSettings) : (b = a, a = f.ajaxSettings),
            _b(a, b),
            a
        },
        ajaxSettings: {
        ...
        ajax: function (a, c) {
            ...
            d.url = ((a || d.url) + "").replace(Gb, "").replace(Lb, Wb[1] + "//"),
            d.dataTypes = f.trim(d.dataType || "*").toLowerCase().split(Pb),
            d.crossDomain == null && (r = Rb.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] == Wb[1] && r[2] == Wb[2] && (r[3] || (r[1] === "http:" ? 80 : 443)) == (Wb[3] || (Wb[1] === "http:" ? 80 : 443)))),
            ...
            if (!d.hasContent) {
                d.data && (d.url += (Mb.test(d.url) ? "&" : "?") + d.data, delete d.data),
                k = d.url;
                if (d.cache === !1) {
                    var x = f.now(),
            ...
            v.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + (d.dataTypes[0] !== "*" ? ", " + Xb + "; q=0.01" : "") : d.accepts["*"]);
    ...
    f.ajaxPrefilter("json jsonp", function (b, c, d) {
        ...
        if (b.dataTypes[0] === "jsonp" || b.jsonp !== !1 && (ec.test(b.url) || e && ec.test(b.data))) {
            ...
            k = b.data,
            l = "$1" + h + "$2";
            return b.jsonp !== !1 && (j = j.replace(ec, l), b.url === j && (e && (k = k.replace(ec, l)), b.data === k && (j += (/\?/.test(j) ? "&" : "?") + b.jsonp + "=" + h))),
            b.url = j,
            b.data = k,
            a[h] = function (a) {
                g = [a]
        ...
        if (!c.crossDomain || f.support.cors) {
            ...
            return {
                send: function (e, g) {
                    ...
                    d = function (a, e) {
                        ...
                        try {
                            if (d && (e || h.readyState === 4)) {
                                d = b,
                                i && (h.onreadystatechange = f.noop, fc && delete hc[i]);
                    ...
                    !c.async || h.readyState === 4 ? d() : (i = ++gc, fc && (hc || (hc = {},
                    f(a).unload(fc)), hc[i] = d), h.onreadystatechange = d)
                },
                abort: function () {
                    d && d(0, 1)
                }
    ...
    f.fn.extend({
        show: function (a, b, c) {
            ...
            d.style && (e = d.style.display, !f._data(d, "olddisplay") && e === "none" && (e = d.style.display = ""), e === "" && f.css(d, "display") === "none" && f._data(d, "olddisplay", vc(d.nodeName)));
            for (g = 0; g < h; g++) {
                d = this[g];
                if (d.style) {
                    e = d.style.display;
        ...
        toggle: function (a, b, c) {
            ...
            return f.isFunction(a) && f.isFunction(b) ? this._toggle.apply(this, arguments) : a == null || d ? this.each(function () {
                ...
                f(this)[b ? "show" : "hide"]()
            }) : this.animate(uc("toggle", 3), a, b, c),
            this
        },
        ...
        animate: function (a, b, c, d) {
            function g() {
                ...
                h = a[i],
                nc.test(h) ? (o = f._data(this, "toggle" + i) || (h === "toggle" ? d ? "show" : "hide" : 0), o ? (f._data(this, "toggle" + i, o === "show" ? "hide" : "show"), j[o]()) : j[h]()) : (k = oc.exec(h), l = j.cur(), k ? (m = parseFloat(k[2]), n = k[3] || (f.cssNumber[i] ? "" : "px"), n !== "px" && (f.style(this, i, (m || 1) + n), l = (m || 1) / j.cur() * l, f.style(this, i, l + n)), k[1] && (m = (k[1] === "-=" ? -1 : 1) * m + l), j.custom(l, m, n)) : j.custom(l, h, ""));
                return !0
            }
            var e = f.speed(b, c, d);
    ...
    "getBoundingClientRect" in c.documentElement ? f.fn.offset = function (a) {
        ...
        while ((b = b.parentNode) && b !== i && b !== h) {
            ...
            l -= b.scrollTop,
            m -= b.scrollLeft,
            b === d && (l += b.offsetTop, m += b.offsetLeft, f.support.doesNotAddBorder && (!f.support.doesAddBorderForTableAndCells || !wc.test(b.nodeName)) && (l += parseFloat(c.borderTopWidth) || 0, m += parseFloat(c.borderLeftWidth) || 0), e = d, d = b.offsetParent),
...
function () {
    function a(b, c, d) {
        ...
        var f = 0,
            g = !0;
        if (e == "[object Array]") {
            if (f = b.length, g = f == c.length) for (; f--;) if (! (g = f in b == f in c && a(b[f], c[f], d))) break
        } else {
            if ("constructor" in b != "constructor" in c || b.constructor != c.constructor) return !1;
            for (var h in b) if (j.call(b, h) && (f++, !(g = j.call(c, h) && a(b[h], c[h], d)))) break;
            if (g) {
                for (h in c) if (j.call(c, h) && !(f--)) break;
                g = !f
            }
        }
        return d.pop(),
    ...
    var w = v.each = v.forEach = function (a, b, c) {
        if (a != null) if (k && a.forEach === k) a.forEach(b, c);
        else if (a.length === +a.length) {
            for (var e = 0, f = a.length; e < f; e++) if (e in a && b.call(c, a[e], e, a) === d) break
        } else for (e in a) if (j.call(a, e) && b.call(c, a[e], e, a) === d) break
    };
    ...
    v.reduce = v.foldl = v.inject = function (a, b, c, d) {
        var e = c !== void 0;
        a == null && (a = []);
        if (m && a.reduce === m) return d && (b = v.bind(b, d)),
    ...
    v.reduceRight = v.foldr = function (a, b, c, d) {
        return a == null && (a = []),
        n && a.reduceRight === n ? (d && (b = v.bind(b, d)), c !== void 0 ? a.reduceRight(b, c) : a.reduceRight(b)) : (a = (v.isArray(a) ? a.slice() : v.toArray(a)).reverse(), v.reduce(a, b, c, d))
    },
    ...
    v.uniq = v.unique = function (a, b, c) {
        ...
        return v.reduce(c, function (c, e, f) {
            if (0 == f || (b === !0 ? v.last(c) != e : !v.include(c, e))) c[c.length] = e,
            d[d.length] = a[f];
            return c
        },
        []),
    ...
    v.bindAll = function (a) {
        var b = g.call(arguments, 1);
        return b.length == 0 && (b = v.functions(a)),
        w(b, function (b) {
            a[b] = v.bind(a[b], a)
        }),
        a
    ...
    v.clone = function (a) {
        return v.isObject(a) ? v.isArray(a) ? a.slice() : v.extend({},
        a) : a
    },
    v.tap = function (a, b) {
        return b(a),
    ...
    v.isArguments = i.call(arguments) == "[object Arguments]" ?
    function (a) {
...
function (a, b) {
    ...
    b.Events = {
        ...
        unbind: function (a, b) {
            ...
            else if (d = c[a]) while ((e = d) && (d = d.next)) {
                if (d.callback !== b) continue;
                e.next = d.next,
                d.context = d.callback = null;
                break
            }
            return this
        },
    ...
    c.extend(b.Model.prototype, b.Events, {
        ...
        set: function (a, b, d) {
            var e;
            c.isObject(a) || a == null ? (e = a, d = b) : (e = {},
            e[a] = b),
            d || (d = {});
            if (!e) return this;
            e.attributes && (e = e.attributes);
            if (d.unset) for (var f in e) e[f] = void 0;
            ...
            for (var f in e) {
                var j = e[f];
                if (!c.isEqual(g[f], j) || d.unset && f in g) d.unset ? delete g[f] : g[f] = j,
                delete h[f],
                this._changed = !0,
                d.silent || this.trigger("change:" + f, this, j, d)
            }
            return i || (!d.silent && this._changed && this.change(d), this._changing = !1),
            this
        },
        unset: function (a, b) {
            return (b || (b = {})).unset = !0,
        ...
        clear: function (a) {
            return (a || (a = {})).unset = !0,
            this.set(c.clone(this.attributes), a)
        },
        fetch: function (a) {
            a || (a = {});
            var c = this,
            ...
            (this.sync || b.sync).call(this, "read", this, a)
        },
        save: function (a, c) {
            c || (c = {});
        ...
        destroy: function (a) {
            ...
            a.error = v(a.error, c, a),
            (this.sync || b.sync).call(this, "delete", this, a)
        },
        url: function () {
    ...
    b.Collection = function (a, b) {
        ...
        c.bindAll(this, "_onModelEvent", "_removeReference"),
        this._reset(),
        a && this.reset(a, {
            silent: !0
        }),
    ...
    c.extend(b.Collection.prototype, b.Events, {
        ...
        add: function (a, b) {
            if (c.isArray(a)) for (var d = 0, e = a.length; d < e; d++) b && b.at == +b.at && d && (b.at += 1),
            this._add(a[d], b);
            else this._add(a, b);
            return this
        },
        remove: function (a, b) {
            if (c.isArray(a)) for (var d = 0, e = a.length; d < e; d++) this._remove(a[d], b);
        ...
        fetch: function (a) {
            ...
            var c = this,
                d = a.success;
            return a.success = function (b, e, f) {
                c[a.add ? "add" : "reset"](c.parse(b, f), a),
                d && d(c, b)
            },
            a.error = v(a.error, c, a),
            (this.sync || b.sync).call(this, "read", this, a)
    ...
    c.extend(b.Router.prototype, b.Events, {
        ...
        route: function (a, d, e) {
            ...
            b.history.route(a, c.bind(function (b) {
                var c = this._extractParameters(a, b);
                e && e.apply(this, c),
                this.trigger.apply(this, ["route:" + d].concat(c))
            },
            this))
        },
        ...
        _routeToRegExp: function (a) {
            return a = a.replace(j, "\\$&").replace(h, "([^/]*)").replace(i, "(.*?)"),
            new RegExp("^" + a + "$")
        },
    ...
    c.extend(b.History.prototype, {
        ...
        getFragment: function (a, b) {
            ...
            return a = decodeURIComponent(a.replace(k, "")),
        ...
        start: function (a) {
            ...
            f && (this.iframe = d('<iframe src="javascript:0" tabindex="-1" />').hide().appendTo("body")[0].contentWindow, this.navigate(b)),
            this._hasPushState ? d(window).bind("popstate", this.checkUrl) : "onhashchange" in window && !f ? d(window).bind("hashchange", this.checkUrl) : setInterval(this.checkUrl, this.interval),
            this.fragment = b,
            m = !0;
            var g = window.location,
                h = g.pathname == this.options.root;
            if (this._wantsPushState && !this._hasPushState && !h) return this.fragment = this.getFragment(null, !0),
            window.location.replace(this.options.root + "#" + this.fragment),
            !0;
            this._wantsPushState && this._hasPushState && h && g.hash && (this.fragment = g.hash.replace(k, ""), window.history.replaceState({},
        ...
        navigate: function (a, b) {
            ...
            document.title, c)) : (this.fragment = c, this._updateHash(window.location, c, b.replace), this.iframe && c != this.getFragment(this.iframe.location.hash) && (b.replace || this.iframe.document.open().close(), this._updateHash(this.iframe.location, c, b.replace))),
    ...
    c.extend(b.View.prototype, b.Events, {
        ...
        delegateEvents: function (a) {
            ...
            for (var b in a) {
                ...
                h === "" ? d(this.el).bind(g, e) : d(this.el).delegate(h, g, e)
            }
        },
    ...
    b.sync = function (a, e, f) {
        ...
        return f.url || (h.url = t(e, "url") || u()),
        !f.data && e && (a == "create" || a == "update") && (h.contentType = "application/json", h.data = JSON.stringify(e.toJSON())),
        b.emulateJSON && (h.contentType = "application/x-www-form-urlencoded", h.data = h.data ? {
            model: h.data
        } : {}),
        ...
        h.type !== "GET" && !b.emulateJSON && (h.processData = !1),
        d.ajax(c.extend(h, f))
    };
    var r = function () {},
        s = function (a, b, d) {
...
define("Audiee/Models.Clip", ["underscore", "backbone"], function (a, b) {
    var c = b.Model.extend({
        ...
        duplicate: function () {
            ...
            a.set("trackPos", b),
            this.collection.addDuplicate(a)
        }
    });
    return c
}),
    ...
    return b.Collection.extend({
        ...
        getSnapshot: function (a, b) {
            ...
            return this.each(function (k) {
                d = k.get("trackPos"),
                e = d + k.clipLength(),
                d < b && e > a && (i = k.get("loop"), j = k.get("buffer").duration, f = d < a ? 0 : d - a, g = k.get("startTime"), h = k.get("endTime"), d < a && (i -= Math.floor((g + a - d) / j), g = (g + a - d) % j), e > b && (i += Math.floor((h + b - e) / j), h = (h - (e - b)) % j, h < 0 && (h += j)), c.push({
                    offset: f,
                    startTime: g,
                    endTime: h,
                    loop: i,
        ...
        deleteSelection: function (a, b, d) {
            ...
            this.each(function (p) {
                if (p.cid !== d) {
                    ...
                    if (g < b && h > a) {
                        k = p.get("loop"),
                        l = p.get("buffer").duration,
                        i = p.get("startTime"),
                        j = p.get("endTime");
                        if (g < a && h > b) {
                            n = (i + a - g) % l,
                            m = k + Math.floor((j + a - h) / l),
                            p.set("loop", m),
                            p.set("endTime", n),
                            o = (i + b - g) % l,
                            m = k - Math.floor((i + b - g) / l);
                            var q = new c({
                                name: p.get("name"),
                                color: p.get("color"),
                                trackPos: b,
...
define("Audiee/Models.Track", ["underscore", "backbone", "Audiee/Collections.Clips", "Audiee/Models.Clip"], function (a, b, c, d) {
    var e = b.Model.extend({
        ...
        initialize: function () {
            a.bindAll(this, "initClip", "remove", "resetDuplicates"),
        ...
        pasteSelection: function (a, b) {
            for (var c = 0, e = b.length; c < e; ++c) {
                var f = new d({
                    ...
                    g = f.get("trackPos"),
                    h = g + f.clipLength();
                Audiee.Collections.Tracks.deleteSelection(g, h, this.cid),
                this.clips.add(f)
            }
        },
        ...
        duplicate: function () {
            ...
            this.duplicates ? this.duplicates.count += 1 : this.duplicates = {
                count: 2
            },
            d = this.duplicates.count,
            c ? b = b.replace(/\(\d+\)$/, " (" + d + ")") : b += " (" + d + ")",
            a.set("name", b),
            a.duplicates = this.duplicates,
...
define("Audiee/Views.PlaybackControls", ["underscore", "backbone"], function (a, b) {
    return b.View.extend({
        ...
        initialize: function () {
            a.bindAll(this, "handleKey"),
            this.render(),
            this.pressingKey = !1,
            $(document).on("keydown", this.handleKey).on("keyup", this.handleKey)
        },
        render: function () {
        ...
        updateTime: function (a) {
            ...
            c += "",
            d = c.indexOf("."),
            d !== -1 && (c = c.substring(0, d + 4)),
            this.el.children("#time-display").val(b + " : " + c)
        },
        play: function () {
...
define("Audiee/Views.Editor", ["jquery", "underscore", "backbone"], function (a, b, c) {
    return c.View.extend({
        ...
        initialize: function () {
            b.bindAll(this, "render", "changeTitle", "resizeView", "scrollHandler", "zoomHandler", "setClipboard"),
            this.model.bind("change:name", this.changeTitle),
            this.moving = !1,
            a("title").text(this.model.get("name") + " :: Audiee"),
            a(window).on("resize", this.resizeView),
            this.resizeView()
        },
        render: function () {
            return this
        ...
        unsetActiveTrack: function () {
            ...
            typeof this.activeTrack != "undefined" && (this.activeTrack.removeClass("active"), this.activeTrack = undefined)
        },
        setSelectionFrom: function (a) {
            this.selectionFrom = a
        },
        setCursor: function (a) {
            this.originalCursor = a,
            this.selectionFrom = a,
            this.selectionTo = a
        },
        ...
        setClipboard: function () {
            ...
            if (!isNaN(this.selectionFrom) && this.selectionFrom !== this.selectionTo) {
                b.from = this.selectionFrom,
                b.to = this.selectionTo,
                b.tracks = {};
                var f = c.index(this.getActiveTrack()),
                    g = f,
                    h;
                this.isMultiSelection() && (g = c.index(this.getMultiSelection()), f > g && (h = f, f = g, g = h)),
                c.slice(f, ++g).each(function () {
                    e = a(this).data("cid"),
                    b.tracks[e] = Audiee.Collections.Tracks.getSnapshot(d.selectionFrom, d.selectionTo, e)
                }),
                this.clipboard = b
            }
        },
        ...
        deleteSelection: function () {
            ...
            if (!isNaN(this.selectionFrom) && this.selectionFrom !== this.selectionTo) {
                var e = b.index(this.getActiveTrack()),
                    f = e,
                    g;
                this.isMultiSelection() && (f = b.index(this.getMultiSelection()), e > f && (g = e, e = f, f = g)),
                b.slice(e, ++f).each(function () {
                    d = a(this).data("cid"),
                    Audiee.Collections.Tracks.deleteSelection(c.selectionFrom, c.selectionTo, d)
                })
            }
        },
        splitClip: function () {
            var a = this.getActiveTrack(),
                b = this.getCursor(),
                c;
            typeof a != "undefined" && (c = a.data("cid")),
            Audiee.Collections.Tracks.getByCid(c).deleteSelection(b, b)
        }
    })
}),
define("Audiee/Views.TrackDisplay", ["jquery", "underscore", "backbone"], function (a, b, c) {
    ...
    c.View.extend({
        ...
        initialize: function () {
            b.bindAll(this, "render", "renderDisplay", "renderCursor", "renderSelection", "cursor", "selection", "contextMenu"),
            this.model.bind("Audiee:zoomChange", this.renderDisplay),
            a(this.el).on("contextmenu", this.wrapperClass, this.contextMenu).on("mousedown", this.wrapperClass, this.cursor).on("mouseup", this.wrapperClass, this.selection),
            this.render()
        },
        render: function () {
        ...
        cursor: function (b) {
            ...
            if (!b.shiftKey) {
                var e = d.index(a(b.target)),
                    ...
                    g = f % this.maxWidth;
                this.clearDisplay(),
                Audiee.Views.Editor.setActiveTrack(c),
                Audiee.Views.Editor.setCursor(Audiee.Display.px2sec(f)),
        ...
        selection: function (b) {
            ...
            Audiee.Views.Editor.isActiveTrack() && Audiee.Views.Editor.getActiveTrack().data("cid") !== c.data("cid") ? Audiee.Views.Editor.setMultiSelection(c) : Audiee.Views.Editor.unsetMultiSelection(),
            this.renderSelection()
        },
        renderSelection: function () {
            ...
            if (!isNaN(b) && b !== c) {
                var l = f.index(Audiee.Views.Editor.getActiveTrack()),
                    m = l;
                Audiee.Views.Editor.isMultiSelection() && (m = f.index(Audiee.Views.Editor.getMultiSelection()), l > m && (j = l, l = m, m = j)),
                c %= this.maxWidth,
                f.slice(l, ++m).each(function () {
                    k = a(this).find(g.wrapperClass).children("canvas"),
                    h = b % g.maxWidth,
                    i = d !== e ? g.maxWidth - h : c - h;
                    for (var f = d; f <= e; ++f) Audiee.Display.drawSelection(k.eq(f)[0], h, i),
                    h = 0,
                    i = f != e - 1 ? g.maxWidth : c
                })
            }
        },
        clearDisplay: function () {
            ...
            if (!isNaN(b)) {
                ...
                f.slice(l, ++m).each(function () {
                    ...
                    h = b % g.maxWidth,
                    i = d !== e ? g.maxWidth - h : c - h;
                    for (var f = d; f <= e; ++f) Audiee.Display.clearDisplay(k.eq(f)[0], h, i),
                    h = 0,
                    i = f != e - 1 ? g.maxWidth : c
                })
            }
...
define("plugins/button", function () {}),
define("Audiee/Views.TrackControls", ["jquery", "underscore", "backbone", "plugins/button"], function (a, b, c) {
    return b.templateSettings = {
        interpolate: /\{\{(.+?)\}\}/g
    },
    c.View.extend({
        ...
        initialize: function () {
            b.bindAll(this, "render", "volumeChange", "solo", "mute"),
            this.render(),
            a("input.volume", this.el).on("change", this.volumeChange),
            a("button.mute", this.el).on("click", this.mute),
            a("button.solo", this.el).on("click", this.solo)
        },
        render: function () {
        ...
        volumeChange: function () {
            ...
            (!Audiee.Collections.Tracks.isAnySolo() || this.model.get("solo")) && Audiee.Player.volumeChange(b, c),
            a("button.mute", this.el).hasClass("active") && (a("button.mute", this.el).button("toggle"), this.mute())
        },
        mute: function () {
            var a = this.model.get("muted");
            this.model.set("muted", !a),
            a ? (!Audiee.Collections.Tracks.isAnySolo() || this.model.get("solo")) && Audiee.Player.volumeChange(this.model.get("gain"), this.model.cid) : this.model.get("solo") || Audiee.Player.volumeChange(0, this.model.cid)
        },
        solo: function () {
...
define("Audiee/Views.ClipDisplay", ["jquery", "underscore", "backbone"], function (a, b, c) {
    ...
    c.View.extend({
        ...
        render: function (b) {
            ...
            Audiee.Display.drawSound(this.getLastCanvas(), this.model.get("buffer"), b, g),
            c -= d,
            g += d;
            while (c > 0);
            return this
...
function (a, b) {
    a.widget("ui.draggable", a.ui.mouse, {
        ...
        _mouseStart: function (b) {
            ...
            this._trigger("start", b) === !1 ? (this._clear(), !1) : (this._cacheHelperProportions(), a.ui.ddmanager && !c.dropBehaviour && a.ui.ddmanager.prepareOffsets(this, b), this.helper.addClass("ui-draggable-dragging"), this._mouseDrag(b, !0), a.ui.ddmanager && a.ui.ddmanager.dragStart(this, b), !0)
        },
...
define("Audiee/Views.Timeline", ["jquery", "underscore", "backbone"], function (a, b, c) {
    return b.templateSettings = {
        interpolate: /\{\{(.+?)\}\}/g
    },
    c.View.extend({
        ...
        initialize: function () {
            ...
            a(window).on("resize", this.render),
            this.render()
        },
        render: function () {
            var b = a(this.el),
        ...
        drawScale: function () {
            var b = a(this.el),
                ...
                l, m, n, o, p;
            c.fillStyle = "#444",
            c.font = "0.8em sans-serif",
            c.clearRect(0, 0, d, e),
            l = i - j % i;
            for (; l < d; l += i) c.fillRect(l, e, 1, -5);
            l = j > 0 ? h - j % h : 0,
            k += Audiee.Display.px2sec(l);
            for (; l < d; l += h) n = Math.floor(k / 60),
            o = Math.floor(k % 60),
            g.interval < 1 && (p = Math.round(k % 1 * 10) % 10),
            m = n + ":",
            m += o < 10 ? "0" + o : o,
            g.interval < 1 && (m += "," + p + "0"),
            c.fillRect(l, e, 1, -12),
    ...
    define("text", [], function () {
        ...
        return typeof window != "undefined" && window.navigator && window.document ? j = function (a, b) {
            ...
            try {
                ...
                h = f.readLine(),
                h && h.length() && h.charAt(0) === 65279 && (h = h.substring(1)),
                g.append(h);
                while ((h = f.readLine()) !== null) g.append(e),
                g.append(h);
                i = String(g.toString())
            } finally {
                f.close()
        ...
        i = {
            ...
            parseName: function (a) {
                ...
                return c = e.indexOf("!"),
                c !== -1 && (b = e.substring(c + 1, e.length), b = b === "strip", e = e.substring(0, c)),
                {
                    moduleName: d,
                    ext: e,
                    strip: b
            ...
            load: function (a, b, c, h) {
                ...
                var j = i.parseName(a),
                    ...
                    l = b.toUrl(k),
                    m = h && h.text && h.text.useXhr || i.useXhr; ! d || m(l, e, f, g) ? i.get(l, function (b) {
...
define("Audiee/Views.EditableName", ["underscore", "backbone", "text!templates/EditableName.html", "text!templates/ContextMenu.html"], function (a, b, c, d) {
    ...
    b.View.extend({
        ...
        menu: a.template(d),
        initialize: function () {
            a.bindAll(this, "render", "close", "edit", "contextMenu", "keyupHandler"),
            this.model.bind("change:name", this.render),
            this.model.bind("change:color", this.render),
            $(this.el).on("keyup", ".name-input", this.keyupHandler).on("blur", ".name-input", this.close).on("contextmenu", ".display", this.contextMenu),
            this.render()
        },
        render: function () {
            ...
            this.options.hasColor && $(this.el).css("background-color", this.model.get("color")),
...
define("Audiee/Views.Clip", ["jquery", "underscore", "backbone", "Audiee/Views.ClipDisplay", "Audiee/Views.EditableName", "drag_resize"], function (a, b, c, d, e) {
    ...
    c.View.extend({
        ...
        className: "clip",
        initialize: function () {
            b.bindAll(this, "render", "remove", "soundwaveRender", "positionRender", "updatePosition", "scrollChange", "_clipWidth"),
        ...
        render: function () {
            ...
            return a(this.el).children().detach().end().css("left", b + "px").width(c).resizable("destroy").append(this.editableName.el).append('<div class="ui-resizable-handle ui-resizable-w">').append('<div class="ui-resizable-handle ui-resizable-e">').append(this.clipDisplay.render(c).el).resizable({
                ...
                resize: function (a, b) {
                    ...
                    b.originalPosition.left === b.position.left ? (h = (Audiee.Display.px2sec(b.size.width) + d.model.get("startTime")) % c, e += Math.floor((d.model.get("endTime") + Audiee.Display.px2sec(b.size.width) - f) / c)) : (g = Audiee.Display.px2sec(b.position.left) - d.model.get("trackPos"), d.model.get("trackPos") <= .05 ? g > 0 ? (g += d.model.get("startTime"), i = Audiee.Display.px2sec(b.position.left)) : (g = d.model.get("startTime"), i = 0) : (g += d.model.get("startTime"), i = Audiee.Display.px2sec(b.position.left)), g %= c, g = g < 0 ? c + g : g, e -= Math.floor((d.model.get("startTime") + i - d.model.get("trackPos")) / c)),
                    d.model.set("loop", e),
                    typeof i != "undefined" && d.model.set("trackPos", i),
                    typeof g != "undefined" && d.model.set("startTime", g),
                    typeof h != "undefined" && d.model.set("endTime", h)
                },
                stop: function () {
                    ...
                    Audiee.Collections.Tracks.deleteSelection(b, c, e, d.model.cid),
                    d.soundwaveRender()
                }
            }),
            this.scrollChange(),
        ...
        updatePosition: function (b) {
            ...
            Audiee.Collections.Tracks.deleteSelection(c, d, e, this.model.cid),
            this.model.set("trackPos", c),
            Audiee.Views.Editor.movingOff()
        },
...
define("Audiee/Views.Clips", ["jquery", "underscore", "backbone", "Audiee/Views.Clip"], function (a, b, c, d) {
    return c.View.extend({
        initialize: function () {
            b.bindAll(this, "render", "addAll", "addOne"),
...
define("Audiee/Views.Track", ["underscore", "backbone", "Audiee/Views.EditableName", "Audiee/Views.TrackDisplay", "Audiee/Views.TrackControls", "Audiee/Views.Clips"], function (a, b, c, d, e, f) {
    return b.View.extend({
        ...
        className: "track",
        initialize: function () {
            a.bindAll(this, "render", "remove", "zoomChange", "clearDisplay"),
            this.model.bind("destroy", this.remove),
        ...
        render: function () {
            ...
            g.append(this.editableName.el).append(this.trackControls.el),
            $(this.el).empty().width(b).attr("data-cid", this.model.cid).append(g).append(this.trackDisplay.el),
            g.css("left", a + "px"),
            (new f({
...
define("Audiee/Views.Tracks", ["jquery", "underscore", "backbone", "Audiee/Views.Track"], function (a, b, c, d) {
    return c.View.extend({
        initialize: function () {
            b.bindAll(this, "render", "addAll", "addOne", "zoomChange", "scrollChange"),
            this.collection.bind("add", this.addOne),
        ...
        render: function () {
            return this.addAll(),
            a(this.el).append('<div id="playback-position">'),
            this
        },
        addAll: function () {
            this.collection.each(this.addOne)
        ...
        scrollChange: function () {
            ...
            a("div.track-info").css("left", b + "px"),
        ...
        zoomChange: function () {
            this.collection.each(function (a) {
                ...
                a.clips.trigger("Audiee:zoomChange")
            })
        },
    ...
    b.prototype = {
        ...
        show: function () {
            ...
            e.call(this, function () {
                var c = a.support.transition && b.$element.hasClass("fade"); ! b.$element.parent().length && b.$element.appendTo(document.body),
                b.$element.show(),
...
define("plugins/modal", function () {}),
define("Audiee/Helpers.Player", ["jquery", "underscore", "backbone", "text!templates/AlertModal.html", "plugins/modal"], function (a, b, c, d) {
    return function () {
        function c() {
        ...
        c.prototype.releaseTrack = function (a) {
            this.gainNodes[a].disconnect(this.context.destination),
            delete this.gainNodes[a]
        },
        c.prototype.play = function () {
            var a = this,
                b = this.context.currentTime;
            this.playbackFrom = b,
            Audiee.Views.Editor.isActiveTrack() && (this.playbackFrom -= Audiee.Views.Editor.getCursor()),
            this.playing && this.stop(),
            Audiee.Collections.Tracks.each(function (c) {
                var d = c.cid,
                    e = a.gainNodes[d];
                c.clips.each(function (c) {
                    ...
                    for (var n = 0; n <= h; ++n) l = a.context.createBufferSource(),
                    a.nodes.push(l),
                    l.buffer = c.get("buffer"),
                    l.connect(e),
                    h > 0 ? n === 0 ? (m = f, i -= m) : n === h ? (m = 0, i = g) : (m = 0, i = c.get("buffer").duration) : (m = f, j ? i = g - f : i = c.clipLength()),
                    l.noteGrainOn(b + d - k, m, i),
                    d += i
                })
            }),
            this.playing = !0,
        ...
        c.prototype.stop = function () {
            ...
            typeof this.playbackPositionInterval != "undefined" && clearInterval(this.playbackPositionInterval),
        ...
        c.prototype.loadFile = function (c, e) {
            ...
            f.onprogress = function (b) {
                if (b.lengthComputable) {
                    $progress = a(".progress", "#newTrackModal"),
                    $progress.hasClass("hide") && $progress.fadeIn("fast");
...
define("Audiee/Helpers.Display", ["jquery", "underscore", "backbone", "plugins/modal"], function (a, b, c, d) {
    return function () {
        function b() {
            ...
            this.scale = 20,
            this.subpixels = 5,
            this.playbackCursorFollowing = !0
        }
        ...
        b.prototype.getIntervals = function (a) {
            var b = Math.ceil(this.px2sec(a * 100)),
                c;
            return b = b > 9e3 ? 120 : b > 6e3 ? 60 : b > 3e3 ? 30 : b > 1500 ? 20 : b > 800 ? 10 : b > 300 ? 5 : b > 150 ? 2 : b > 60 ? 1 : b > 30 ? .5 : b > 5 ? .2 : .1,
            c = b == 120 ? 4 : b == 60 ? 4 : b == 30 ? 3 : b == 20 ? 4 : b == 10 ? 4 : b == 5 ? 5 : b == 2 ? 4 : b == 1 ? 4 : b == .5 ? 5 : b == .2 ? 4 : 5,
            {
                interval: b,
                subdivision: c
            }
        },
        b.prototype.getSubinterval = function (a) {},
        b.prototype.frameRMS = function (a, b, c) {
            var d = 0;
            for (var e = 0; e < c; ++e) d += a[b + e] * a[b + e];
            return Math.sqrt(d / c)
        },
        b.prototype.frameMax = function (a, b, c) {},
        b.prototype.clearDisplay = function (a, b, c) {
        ...
        b.prototype.drawSound = function (a, b, c, d) {
            ...
            val = 0,
            posX = 0,
            i = d * f * this.subpixels % b.length,
            b.numberOfChannels > 1 && (h = b.getChannelData(1)),
            e.fillStyle = "red",
            e.beginPath(),
            e.moveTo(posX, j);
            while (posX <= a.width) val = g[Math.floor(i)],
            i = (i + f) % b.length,
            e.lineTo(posX, val * j + j),
            i >= 0 && i <= f && (e.globalCompositeOperation = "destination-over", e.fillRect(posX, 0, 1, 10), e.fillRect(posX, a.height - 10, 1, 10), e.globalCompositeOperation = "source-over"),
        ...
        b.prototype.showPlaybackPosition = function (b) {
            ...
            Audiee.Views.PlaybackControls.updateTime(this.px2sec(b)),
            b += 120,
            c.height(d * e).css("left", b + "px").show(),
            this.playbackCursorFollowing && (b > g + f || b < g) && Audiee.Views.Editor.el.scrollLeft(b - 120)
        },
...
define("Audiee/Views.Menu", ["underscore", "backbone", "text!templates/Menu.html", "text!templates/NewtrackModal.html", "text!templates/AlertModal.html", "text!templates/InfoModal.html", "text!templates/AboutAudiee.html", "text!templates/HelpAudiee.html", "Audiee/Models.Track", "plugins/modal", "plugins/dropdown"], function (a, b, c, d, e, f, g, h, i) {
    return b.View.extend({
        ...
        initialize: function () {
            a.bindAll(this, "render", "_fileSelected", "_fileLoaded", "handleKey"),
        ...
        toggleFullscreen: function () {
            var a = $("html");
            a.hasClass("fullscreen") ? document.webkitCancelFullScreen() : a[0].webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT),
...
define("app", ["require", "jquery", "underscore", "backbone", "Audiee/Helpers.Player", "Audiee/Helpers.Display", "Audiee/Models.Project", "Audiee/Collections.Tracks", "Audiee/Views.PlaybackControls", "Audiee/Views.EditableName", "Audiee/Views.Editor", "Audiee/Views.Tracks", "Audiee/Views.Menu", "Audiee/Views.Timeline", "text!templates/AlertModal.html", "plugins/modal"], function (a) {
    ...
    var q = function () {
        window.Audiee = p,
        p.Collections.Tracks = new h,
        p.Models.Project = new g,
        p.Views.Editor = new k({
            model: p.Models.Project
        }),
        p.Views.Timeline = new n,
        p.Views.Tracks = (new l({
        ...
        window.onbeforeunload = function (a) {
            ...
            a && (a.returnValue = "By leaving this page, all changes will be lost."),
